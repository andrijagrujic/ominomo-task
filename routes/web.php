...
Route::get('/posts/create', [Post::class, 'create'])->name('createPost');
Route::post('/posts/save', [Post::class, 'store'])->name('savePost');
Route::get('/posts/{id}', [Post::class, 'show'])->name('showPost');
Route::get('/posts/{id}/edit', [Post::class, 'edit'])->name('editPost');
